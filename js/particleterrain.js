$(document).ready(function() {
    ...
    function Terrain(options) {
        ...
        var x = mapDimension,
        y = mapDimension,
        mapDimension = this.mapDimension, tr, tl, t, br, bl, b, r, l, center;
    ...
    Terrain.prototype.displacment = function(dim) {
        var newDimension = dim/2, top, topRight, topLeft, bottom, bottomLeft, bottomRight, right, left, center, i, j,
            map = this.map,
    ...
    Emitter.prototype.render = function() {
        ...
        for (var i = 0; i < partLen; i++) {
            ...
            if (particle.visible && particle.xPos < width && particle.xPos > 0 && particle.yPos > 0 && particle.yPos < height) {
